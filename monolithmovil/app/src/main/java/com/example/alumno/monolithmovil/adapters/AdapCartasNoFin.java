...
public class AdapCartasNoFin extends BaseAdapter {
    ...
    public AdapCartasNoFin(Context contexto, ArrayList<ActividadesCartas> lista) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final View Vista=infleter.inflate ( R.layout.carta_act_no_finalizada,null);
