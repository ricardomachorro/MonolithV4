...
public class Logros extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView2.loadUrl("http://192.168.0.16:8080/MonolithV4/prueba/logrover.jsp?usuario="+Utilidades.usuario+"");
    ...
    private void cargarWebservice() {
        ...
        String url="http://192.168.0.16:8080/MonolithV4/prueba/agrelogro.jsp?nombre="+Utilidades.usuario+"";
        webView2.loadUrl("http://192.168.0.16:8080/MonolithV4/prueba/logrover.jsp?usuario="+Utilidades.usuario+"");
