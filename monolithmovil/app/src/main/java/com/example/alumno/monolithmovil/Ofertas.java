...
public class Ofertas extends Fragment {
     ...
     * @return A new instance of fragment Ofertas.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView1=(WebView) view.findViewById(R.id.web3);
        webView1.getSettings().setJavaScriptEnabled(true);
        webView1.setWebViewClient(new WebViewClient());
        webView1.setWebViewClient(new WebViewClient());
        webView1.setWebChromeClient(new WebChromeClient());
        webView1.loadUrl("http://"+MainActivity.IP+":8080/MonolithV4/prueba/Ofertas.jsp?usuario="+ Utilidades.usuario+"");
        return view;
    }
