...
insert into Logro(IDUsuario,Img,Filtro,Nombre,fecha) values(1,02,05,'dogo #97','2017-05-12');
insert into Logro(IDUsuario,Img,Filtro,Nombre,fecha) values(2,01,07,'dogo #12','2017-03-01');
select * from Logro;
select * from Usuario;
