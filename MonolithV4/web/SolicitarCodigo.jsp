        ...
        <form  class="form-register " role="form" id="Terminar"><!-- method="POST" action="CifrarAdendum.jsp" >-->
            ...
            <div class="contenedor-inputs container-fluid ">
                ...
                <div class="form-group row" style="width:100%;">
                    ...
                    <div class="col-6">
                        <input type="text" class=" form-control " style="width:100%;margin-top:10px;" id="codigo" name="codigo" placeholder="Ingresa el código de verificación"  />
                    </div>
                </div>
                ...
                <div class="form-group row" style="width:100%;">
                    ...
                    <div class="col-6">
                        <input type="password" class="form-control" style="width:100%;margin-top:10px;" id="contra" name="contra" placeholder="Ingresa la contraseña con la que te registraste" />
                    </div>
                </div>               
